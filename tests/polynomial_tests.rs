...
fn test_sin_approx_polynomial() {
    ...
    const fn inner() -> bool {
        // Single-term: one term with sin applied once
        ...
        // Single-term: one term with two sin functions (two variables)
        ...
        // Single-term: one term with three sin functions (three variables)
        ...
        // Single-term: same as above, different input values
